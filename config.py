...
OWNER_USERNAME = os.getenv("OWNER_USERNAME", "II_SHIVA_THE_BOSS_II")
...
SUPPORT_CHANNEL = os.getenv("SUPPORT_CHANNEL", "https://t.me/SHIVA_MUSIC_SUPPORT")
SUPPORT_GROUP = os.getenv("SUPPORT_GROUP", "https://t.me/THE_HOUSE_CHATTING")
